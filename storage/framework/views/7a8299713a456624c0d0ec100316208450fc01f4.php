...
<div class="row">
	<div class="col-md-12 mt-2">
		<div class="card card-box-shadow p-4 mh-425">
			...
			<div class="col-md-6">
				<a class="float-end btn btn-success btn-sm" href="<?php echo e(route('site.appoinment.booking1')); ?>"><i class="fas fa-clock"></i> <?php echo e(translate('Nueva Cita')); ?></a></div>
			</div>
...
<?php echo $__env->make('site.layouts.site-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/link/lp/vet/resources/views/site/client/client-dashboard.blade.php ENDPATH**/ ?>