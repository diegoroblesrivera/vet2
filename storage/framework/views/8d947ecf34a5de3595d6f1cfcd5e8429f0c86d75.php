		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-xs-12 banner-right-content">
				...
				<div class="margin-top-110 float-right-banner">
					<a href="<?php echo e(route('site.appoinment.booking')); ?>" class="btn btn-booking btn-lg btn-full-round">Nueva Version Agenda<i class="far fa-clock"></i></a>
				</div>
			</div>
		</div>
	</div>
...
<?php echo $__env->make('site.layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/link/lp/vet/resources/views/site/index.blade.php ENDPATH**/ ?>