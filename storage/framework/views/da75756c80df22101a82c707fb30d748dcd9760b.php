		...
		<div class="card card-box-shadow card-pending-booking p-4">
			<div class="w-100 pb-3">
				<div class="d-flex align-items-center justify-content-between">
					<h5 class="mb-0"><?php echo e(translate('Listado de Mascotas')); ?> </h5>
						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<?php $__currentLoopData = $pets ?? ''; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mascota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr>
												<td><a href="<?php echo e(route('petdeta', ['id' => $mascota->id])); ?>"><?php echo e($mascota->nombre); ?></a></td>
												<td><?php echo e($mascota->especie); ?></td>
												<td><?php echo e($mascota->sexo); ?></td>
												<td><a href="<?php echo e(route('petdeta', ['id' => $mascota->id])); ?>" class="btn btn-info">Ver Detalles</a></td>
												<td>
													<div class="dropdown">
														<button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton_<?php echo e($mascota->id); ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
															<?php echo e(html_entity_decode($mascota->estado_pet)); ?>

														</button>
														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton_<?php echo e($mascota->id); ?>">
															
															<a class="dropdown-item" href="#" onclick="cambiarEstado('<?php echo e($mascota->id); ?>', 'Extraviado')">Extraviado</a>
															<a class="dropdown-item" href="#" onclick="cambiarEstado('<?php echo e($mascota->id); ?>', 'Recuperado')">Recuperado</a>
															<a class="dropdown-item" href="#" onclick="cambiarEstado('<?php echo e($mascota->id); ?>', 'Defuncion')">Defunción</a>
														</div>
													</div>
...
<script src="<?php echo e(dsAsset('site/js/custom/client/client-listingpets.js')); ?>"></script>
    ...
    <div class="modal fade bd-example-modal-lg" id="petModal" tabindex="-1" role="dialog" aria-labelledby="modalInmunizacionLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="peluForm" action="<?php echo e(route('pet.petStore')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                <!-- Campo oculto para el ID del servicio -->
                <?php echo e(csrf_field()); ?> 
      
                <input type="hidden" id="id_dueno" name="id_dueno"  value="<?php echo e($cliente); ?>" >
                ...
                <button type="button" class="btn btn-default btn-sm" data-bs-dismiss="modal"><?php echo e(translate('Cerrar')); ?></button>
...
<?php echo $__env->make('site.layouts.site-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/link/lp/vet/resources/views/site/client/client-pending-booking.blade.php ENDPATH**/ ?>