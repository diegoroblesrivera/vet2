...
<div class="row">
                    ...
                    <div class="container">
                        ...
                        <div class="row gx-1 ">
                                   ...
                                   <div class="card mb-3" style="max-width: 540px;">
                                    <div class="row no-gutters">
                                      <div class="col-md-4 d-flex justify-content-center align-items-center">
                                        ...
                                        <?php if($pets->imagen_pet): ?>
                                        <img src="<?php echo e(asset($pets->imagen_pet)); ?>" alt="dogo" class="img-fluid rounded-circle" style="object-fit: cover; width: 100%; max-width: 100px; height: 100px;">
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                      ...
                                      <div class="col-md-8">
                                        <div class="card-body">
                                          <h5 class="card-title"><?php echo e($pets->nombre); ?> <?php if($pets->estado_pet): ?>
                                            (<?php echo e($pets->estado_pet); ?>)
                                        <?php endif; ?></h5>
                                          <p class="card-text"><?php echo e($pets->especie); ?>, <?php echo e($pets->sexo); ?>, <?php echo e($pets->raza); ?></p>
                                          <p class="card-text"><small class="text-muted">
                                            ...
                                            <div>
                                                <p>Edad de la mascota: <?php echo e($years); ?> años y <?php echo e($months); ?> meses.</p>
                                            </div>
                                            </small></p>
                                            <form id="formulario-imagen" action="<?php echo e(route('actualizar_imagen', ['id' => $id])); ?>" method="POST" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                            ...
                            <div class="col-lg-6 col-md-6 font-weight-bold">
                                <a href="<?php echo e(route('site.client.pets.listing')); ?>"> <button type="button" class="btn btn-info">Volver</button></a>
                            </div>
                            <?php else: ?>
                            ...
                            <div class="col-lg-6 col-md-6 font-weight-bold">
                                ...
                                <a class="dropdown-item" href="#" onclick="openPeluqueria()"><i class="fas fa-cut"></i> Peluqueria</a>
                                                        ...
                                                        <!-- Botón para cambiar el estado con advertencia -->
                                                                <form id="form-cambiar-estado" method="POST" action="<?php echo e(route('cambiar_estado_ultima_cita', ['idMascota' => $id])); ?>">
                                                                    <?php echo csrf_field(); ?>
                                                                    <button type="button" class="btn btn-danger" onclick="confirmarCambioEstado()">Cambiar Estado</button>
                                                                </form>
                                                <a href="<?php echo e(route('home')); ?>"> <button type="button" class="btn btn-info">Volver</button></a>
                        </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                           ...
                                           <a href="#" onclick="opencli('<?php echo e($id); ?>')"> <i class="fas fa-edit"></i></a>
                                ...
                                <div class="container">
                                    ...
                                    <div class="col-lg-2 col-6 col-sm-6 font-weight-bold">
                                            <?php echo e($pets->pet_birth_date); ?>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-6 col-sm-6 font-weight-bold"><?php echo e($pets->owner->full_name); ?></div>
                                        
                                        <div class="col-lg-1 col-6 col-sm-6">Run</div>
                                        <div class="col-lg-2 col-6 col-sm-6 font-weight-bold"><?php echo e($pets->owner->run); ?></div>
                                        
                                        <div class="col-lg-1 col-6 col-sm-6">Email</div>
                                        <div class="col-lg-3 col-6 col-sm-6 font-weight-bold"><?php echo e($pets->owner->email); ?></div>
                                    </div>
                                </div>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-2 col-6 col-sm-6">Direccion</div>
                                        <div class="col-lg-3 col-6 col-sm-6 font-weight-bold"><?php echo e($pets->owner->direccion); ?></div>
                                        
                                        <div class="col-lg-1 col-6 col-sm-6">Celular</div>
                                        <div class="col-lg-2 col-6 col-sm-6 font-weight-bold"><?php echo e($pets->owner->phone_no); ?></div>
                                        
                                        <div class="col-lg-1 col-6 col-sm-6">Ciudad</div>
                                        <div class="col-lg-3 col-6 col-sm-6 font-weight-bold"><?php echo e($pets->owner->city); ?></div>
                                    </div>
                                </div>

                        </div>
                        <div class="tab-pane" id="tabs-2" role="tabpanel">
                            <a href="#" onclick="openante('<?php echo e($id); ?>')"> <i class="fas fa-edit"></i></a>
                            ...
                            <div class="container">
                                ...
                                <div class="col-lg-3 col-6 col-md-6 font-weight-bold">
                                    ...
                                    data-id-pet="<?php echo e($ant->id_pet); ?>" <?php echo e($ant->esteril == 'Si' ? 'checked' : ''); ?>>
                                </div>
                                ...
                                <div class="col-lg-3 col-6  col-md-6 font-weight-bold">
                                    ...
                                    data-id-pet="<?php echo e($ant->id_pet); ?>" <?php echo e($ant->despara == 'Si' ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-md-12">
                                        <div class="main-timeline4">
                                            ...
                                            <div class="timeline">
                                                ...
                                                <span class="year"><?php echo e(\Carbon\Carbon::parse($evento->created_at)->format('M-d')); ?>

                                                    </span>
                                                <div class="timeline-content">
                                                    <h3 class="title">
                                                    <?php switch($evento->tipo_evento):
                                                        case ('Consulta'): ?>
                                                            <i class="fas fa-heartbeat"></i>
                                                            <?php $main = $evento->conid; $tipoe = 'openCancelModal'; ?>
                                                            <?php break; ?>
                                            
                                                        <?php case ('Inmunización'): ?>
                                                            <i class="fas fa-shield-alt"></i>
                                                            <?php $main = $evento->conid; $tipoe = 'openInmu'; ?>
                                                            <?php break; ?>
                                            
                                                        <?php case ('Desparasitación'): ?>
                                                            <i class="fas fa-bug"></i>
                                                            <?php $main = $evento->conid; $tipoe = 'openDespa'; ?>
                                                            <?php break; ?>
                                            
                                                        <?php case ('Cirugía'): ?>
                                                            <i class="fas fa-stethoscope"></i>
                                                            <?php $main = $evento->conid; $tipoe = 'openCirugia'; ?>
                                                            <?php break; ?>
                                            
                                                        <?php case ('Peluqueria'): ?>
                                                            <i class="fas fa-cut"></i>
                                                            <?php $main = $evento->conid; $tipoe = 'openPeluqueria'; ?>
                                                            <?php break; ?>
                                            
                                                        <?php default: ?>
                                                            <i class="fas fa-question-circle"></i>
                                                    <?php endswitch; ?> <?php echo e($evento->tipo_evento); ?> </h3>
                                                    <p class="description">
                                                        <?php echo e($evento->razon); ?>

                                                    </p>
                                                    <p>Fecha: <?php echo e($evento->created_at); ?></p>
                                                    <a href="#" onclick="<?php echo e($tipoe); ?>('<?php echo e($main); ?>')">Abrir detalle</a>
                                                </div>
                                            </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="inmuModal" tabindex="-1" role="dialog" aria-labelledby="modalInmunizacionLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="cmn_pet_idinmu" name="cmn_pet_idinmu" value="<?php echo e($id); ?>">
    ...
    <div class="modal fade bd-example-modal-lg" id="despaModal" tabindex="-1" role="dialog" aria-labelledby="modalInmunizacionLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="cmn_pet_iddespa" name="cmn_pet_iddespa" value="<?php echo e($id); ?>">
    ...
    <div class="modal fade bd-example-modal-lg" id="cirugiaModal" tabindex="-1" role="dialog" aria-labelledby="modalInmunizacionLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="cmn_pet_idcirugia" name="cmn_pet_idcirugia" value="<?php echo e($id); ?>">
    ...
    <div class="modal fade bd-example-modal-lg" id="peluModal" tabindex="-1" role="dialog" aria-labelledby="modalInmunizacionLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="cmn_pet_idpelu" name="cmn_pet_idpelu"  value="<?php echo e($id); ?>" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group control-group controls">
                            <label><?php echo e(translate('Tipo de Corte')); ?></label>
        ...
        <div class="modal-content">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade " id="home" role="tabpanel" aria-labelledby="home-tab"><h3>Antecedentes</h3>
                    ...
                    <input type="hidden" id="cmn_pet_idconsu" name="cmn_pet_idconsu" value="<?php echo e($id); ?>" >
                    <input type="hidden" id="id_consu" name="id_consu" value="">
                    <input type="hidden" id="tieneconsu" name="tieneconsu" value="">
                    <input type="hidden" name="_tokenconsu" value="<?php echo e(csrf_token()); ?>">
    ...
    <div class="modal fade bd-example-modal-lg" id="cliModal" tabindex="-1" role="dialog" aria-labelledby="modalclinizacionLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="cliForm" action="<?php echo e(route('customer.cliStore')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                <!-- Campo oculto para el ID del servicio -->
                <?php echo e(csrf_field()); ?>

                <input type="hidden" id="id_dueno" name="id_dueno" value="">
                <input type="hidden" id="cmn_pet_idcli" name="cmn_pet_idcli" value="<?php echo e($id); ?>">
                <input type="hidden" id="idcli" name="idcli" value="">
                <input type="hidden" id="tienecli" name="tienecli" value="">
                <input type="hidden" name="_tokencli" value="<?php echo e(csrf_token()); ?>">
...
<!-- Finodal mascota y cliente -->
    ...
    <div class="modal fade bd-example-modal-lg" id="anteModal" tabindex="-1" role="dialog" aria-labelledby="modalantenizacionLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="anteForm" action="<?php echo e(route('customer.anteStore')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                <!-- Campo oculto para el ID del servicio -->
                <?php echo e(csrf_field()); ?>

                <input type="hidden" id="id_dueno" name="id_dueno" value="">
                <input type="hidden" id="cmn_pet_idante" name="cmn_pet_idante" value="<?php echo e($id); ?>">
                <input type="hidden" id="id_petante" name="id_petante" value="">
                <input type="hidden" id="tieneante" name="tieneante" value="">
                <input type="hidden" name="_tokenante" value="<?php echo e(csrf_token()); ?>">
...
<script src="<?php echo e(dsAsset('js/custom/pet/pets2.js')); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/link/lp/vet/resources/views/pet/show.blade.php ENDPATH**/ ?>