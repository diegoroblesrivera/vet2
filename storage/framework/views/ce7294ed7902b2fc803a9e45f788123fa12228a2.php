<!DOCTYPE html>
<html lang="zxx" class="no-js" dir="<?php echo e($rtl); ?>">
<head>
	...
	<header class="header">
		<div class="header-top">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						<div class="text-lg-end mt-2 mt-lg-0 header-top-right <?php echo e($rtl=='rtl'?'float-start':'float-end	'); ?>">
							...
							<a class="me-3 color-white fs-12" href="<?php echo e(route('site.appoinment.booking')); ?>"><span> <i class="far fa-clock"></i> <?php echo e(translate('Book Now')); ?></span></a>
							
							<a class="me-3 color-white fs-12 cart" href="<?php echo e(route('site.cart')); ?>"><i class="fas fa-shopping-cart"></i><span class="cart-count" id="cart-count"><?php echo e(session()->get('user_cart',collect([]))->count()); ?></span></a>
							<?php if(auth()->check() && auth()->user()->user_type==2): ?>
							<div class="dropdown">
								<a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
								  <?php echo e(translate('My Panel')); ?>

								</a>
							  
								<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
								  <li><a class="dropdown-item" href="<?php echo e(route('site.client.profile')); ?>"><i class="fa fa-user client-menu-icon"></i> <?php echo e(translate('Perfil')); ?></a></li>
								  <li><a class="dropdown-item" href="<?php echo e(route('client.dashboard')); ?>"><i class="fa fa-home client-menu-icon"></i> <?php echo e(translate('Panel Principal')); ?></a></li>
								  <li><a class="dropdown-item" href="<?php echo e(route('site.client.pets.listing')); ?>"><i class="fas fa-cat client-menu-icon"></i> <?php echo e(translate('Pets')); ?></a></li>
								  <div class="dropdown-divider"></div>
								  <li><a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt client-menu-icon"></i> <?php echo e(translate('Sign Out')); ?></a></li>
		...
		<nav class="navbar navbar-expand-lg navbar-light navigation" id="navbar">
			<div class="container">
				...
				<div class="collapse <?php echo e($rtl=='rtl'?'navbar-collapse-rtl':''); ?> navbar-collapse" id="navbar-main">
...
</html><?php /**PATH /home/link/lp/vet/resources/views/site/layouts/site.blade.php ENDPATH**/ ?>