        ...
        <table style="width: 50%;">
            <tbody>
                <tr>
                    ...
                    <td style="width: 50.0000%;"><br><?php echo e($param1); ?></td>
                </tr>
                <tr>
                    <td style="width: 50.0000%;">Hora</td>
                    <td style="width: 50.0000%;"><br><?php echo e($param2); ?></td>
                </tr>
                
                <tr>
                    <td style="width: 50.0000%;">Nombre Cliente</td>
                    <td style="width: 50.0000%;"><br><?php echo e($param4); ?></td>
                </tr>
                <tr>
                    <td style="width: 50.0000%;">Nombre Mascota</td>
                    <td style="width: 50.0000%;"><br><?php echo e($param5); ?></td>
                </tr>
                <tr>
                    <td style="width: 50.0000%;">Motivo</td>
                    <td style="width: 50.0000%;"><br><?php echo e($param6); ?></td>
                </tr>
            </tbody>
        </table>
        <div class="row">
...
<?php /**PATH /home/link/lp/vet/resources/views/emails/test.blade.php ENDPATH**/ ?>