...
Route::get('/enviar-correo', [App\Http\Controllers\Site\SiteController::class,  'enviarCorreo'])->name('enviar.correo');
...
//Route::post('despa-create', [\App\Http\Controllers\Customer\CustomerController::class, 'despaStore'])->name('customer.despastore');
Route::post('despa-create', [\App\Http\Controllers\Customer\CustomerController::class, 'despaStore'])->name('customer.despastore');
Route::post('cirugia-create', [\App\Http\Controllers\Customer\CustomerController::class, 'cirugiaStore'])->name('customer.cirugiaStore');
Route::post('pelu-create', [\App\Http\Controllers\Customer\CustomerController::class, 'peluStore'])->name('customer.peluStore');
Route::post('pet-create', [\App\Http\Controllers\Pet\PetController::class, 'petStore'])->name('pet.petStore');
// Guardar Imagenes

Route::post('/actualizar-imagen/{id}', [\App\Http\Controllers\Pet\PetController::class, 'actualizarImagen'])->name('actualizar_imagen');

//Obtener datos desde las citas agendadas
Route::get('obtener-cita/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerCita'])->name('customer.obtenercita');
Route::get('obtener-inmu/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerInmu'])->name('customer.obtenerInmu');
Route::get('obtener-despa/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerDespa'])->name('customer.obtenerdespa');
Route::get('obtener-cirugia/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerCirugia'])->name('customer.obtenerCirugia');
Route::get('obtener-pelu/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerPelu'])->name('customer.obtenerPelu');
//Obtener datos desde el perfil de la mascota
Route::get('obtener-inmupet/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerInmupet'])->name('customer.obtenerInmupet');
Route::get('obtener-despapet/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerDespapet'])->name('customer.obtenerDespapet');
Route::get('obtener-cirugiapet/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerCirugiapet'])->name('customer.obtenerCirugiapet');
Route::get('obtener-pelupet/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerPelupet'])->name('customer.obtenerPelupet');
Route::get('obtener-consu/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerConsu'])->name('customer.obtenerConsu');
//actualizar cliente y mascota
Route::get('obtener-pet/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerPet'])->name('customer.obtenerPet');
//actualizar antecedentes
Route::get('obtener-antepet/{serviceId?}', [\App\Http\Controllers\Customer\CustomerController::class, 'obtenerantePet'])->name('customer.obtenerantePet');

Route::get('/get-pets-by-customer/{customerId}', [\App\Http\Controllers\Dropdown\DropdownController::class, 'getPetsByCustomer']);
Route::post('/check-email', [App\Http\Controllers\Booking\SchServiceBookingController::class, 'checkEmail'])->name('check.email');
Route::post('/cambiar-estado-ultima-cita/{idMascota}', 
[App\Http\Controllers\Booking\SchServiceBookingController::class, 'cambiarEstadoUltimaCita'])->name('cambiar_estado_ultima_cita');
Route::get('from', [App\Http\Controllers\Site\WebsiteBookingControllerr::class, 'from'])->name('from');

Route::get('petdeta/{id?}', [\App\Http\Controllers\Pet\PetController::class, 'petdeta'])->name('petdeta');
Route::get('petdeta2/{id?}', [\App\Http\Controllers\Pet\PetController::class, 'petdeta2'])->name('petdeta2');
Route::post('/actualizar-antecedente', [\App\Http\Controllers\Pet\PetController::class, 'actualizar'])->name('actualizar');
...
Route::group(['middleware' => 'xssProtection'], function () {
    ...
    Route::group(['middleware' => 'verifyWebsiteRoute'], function () {
        ...
        Route::get('booking-complete', [App\Http\Controllers\Site\SiteController::class, 'bookingComplete'])->name('booking.complete');
    ...
    Route::group(['middleware' => 'verified'], function () {
        ...
        Route::group(['middleware' => 'verifyWebsiteRoute'], function () {
            ...
            Route::post('client-dashboard-available-confirmar-booking', [App\Http\Controllers\Site\ClientDashboardController::class, 'availableToConfirmarBooking'])->name('client.dashboard.available.to.confirmar.booking');
            Route::post('actualizar-estado', [App\Http\Controllers\Pet\PetController::class, 'actualizarEstado'])->name('actualizarEstado');
            ...
            Route::get('site-client-pets-listing', [App\Http\Controllers\Site\ClientPendingBookingController::class, 'clientPetsListing'])->name('site.client.pets.listing');
        ...
        Route::group(['middleware' => 'verifyUserType'], function () {
            ...
            //get pet
            //Route::get('get-customer', [\App\Http\Controllers\Customer\CustomerController::class, 'getAllCustomer'])->name('customer.get');
            Route::get('pet', [\App\Http\Controllers\Pet\PetController::class, 'pet'])->name('pet');
            Route::get('pets', [\App\Http\Controllers\Pet\PetController::class, 'pets'])->name('pets');
            Route::get('get-pet/{id_dueno?}', [\App\Http\Controllers\Pet\PetController::class, 'getPet'])->name('get.pet');
            // Route::get('get-pet/{id_dueno?}', [\App\Http\Controllers\Pet\PetController::class, 'getPet'])->name('get.pet');
            Route::get('get-pets', [\App\Http\Controllers\Pet\PetController::class, 'getPets'])->name('get.pets');
        ...
        Route::group(['middleware' => ['permission']], function () {
            ...
            //creacion de usuario desde la administracion
            ...
            //Pet
            Route::get('pet/{id_dueno?}', [\App\Http\Controllers\Pet\PetController::class, 'pet'])->name('pet');
            ...
            //para guardas las citas desde el usuario logeado
            Route::post('save-service-booking1', [App\Http\Controllers\Booking\SchServiceBookingController::class, 'saveBooking1'])->name('save.service.booking1');
