                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group control-group form-inline controls">
                                        ...
                                        <input type="text" id="nombre" name="nombre" placeholder="{{translate('Nombre')}}" required data-validation-required-message="El nombre de la mascota es requerida" class="form-control input-full" />
...
<script src="{{dsAsset('js/custom/pet/pets.js')}}"></script>
