						...
						<div class="text-lg-end mt-2 mt-lg-0 header-top-right {{$rtl=='rtl'?'float-start':'float-end	'}}">
							...
							<div class="dropdown">
								...
								<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
								  <li><a class="dropdown-item" href="{{ route('site.client.profile') }}"><i class="fa fa-user client-menu-icon"></i> {{ translate('Perfil') }}</a></li>
								  <li><a class="dropdown-item" href="{{ route('client.dashboard') }}"><i class="fa fa-home client-menu-icon"></i> {{ translate('Panel Principal') }}</a></li>
								  <li><a class="dropdown-item" href="{{ route('site.client.pets.listing') }}"><i class="fas fa-cat client-menu-icon"></i> {{ translate('Pets') }}</a></li>
								  <div class="dropdown-divider"></div>
								  <li><a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt client-menu-icon"></i> {{ translate('Sign Out') }}</a></li>
